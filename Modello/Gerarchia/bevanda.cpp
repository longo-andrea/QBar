...
Bevanda::Bevanda(const std::string& nomeProdotto, double carboidratiBevanda, double proteineBevanda, double grassiBevanda, bool alcoholicBevanda, int scadenzaProdotto, int etaMinimaProdotto)
